...
namespace TreatTracker.Controllers
{
    ...
    public class TreatsController : Controller
    {
        ...
        {
#nullable enable
            FlavorTreat? flavorTreat = _db.FlavorTreats.FirstOrDefault(
                join => (join.FlavorId == flavorId && join.TreatId == treat.TreatId)
            );
#nullable disable
            if (flavorTreat == null && flavorId != 0)
            {
                _db.FlavorTreats.Add(
        ...
        {
            FlavorTreat joinEntry = _db.FlavorTreats.FirstOrDefault(
                entry => entry.FlavorTreatId == joinId
            );
